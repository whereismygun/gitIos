...
export const AView = createAnimatableComponent(ReactNative.View);
export const AText = createAnimatableComponent(ReactNative.Text);
export const AImage = createAnimatableComponent(ReactNative.Image);
