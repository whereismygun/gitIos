...
class MyIncreaseCouponView extends Component {
           ...
           <TouchableOpacity activeOpacity={(onPress ? 0.7 : 1)} onPress={onPress} style={styles.cellContainer}>
                <FlyImage source={bgUrl} style={styles.baImages}>
                  ...
                  <View style={styles.cellLeft}>
                        <Text style={styles.cellLeftText}>{parseFloat(rowData.amount)*100}<Text style={{color:FlyColors.white}} >%</Text></Text>
    ...
    render() {
      ...
      return (
        <View style={FlyStyles.container}>
          <FlyHeader foreground="dark" title={"我的加息券"} leftItem={leftItem} borderBottom={true} backgroundColor={FlyColors.white}/>
...
module.exports = connect(select)(MyIncreaseCouponView);
